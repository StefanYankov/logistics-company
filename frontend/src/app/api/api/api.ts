...
export const APIS = [AuthenticationAPIService, CityAPIService, ClientAPIService, CompanyAPIService, EmployeeManagementAPIService, OfficeAPIService, ServiceCatalogAPIService, ShipmentAPIService];
