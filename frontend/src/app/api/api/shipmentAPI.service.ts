...
export class ShipmentAPIService extends BaseService {
     ...
     * Retrieves a paginated list of shipments where the specified client is the receiver. Restricted to staff roles.
     ...
     * Retrieves a paginated list of shipments where the specified client is the sender. Restricted to staff roles.
     ...
     * Creates a new shipment, calculates the price, and logs the initial REGISTERED status. Restricted to staff roles.
