...
class ClientRepositoryIntegrationTest {
    ...
    private Client createAndSaveClient(String username, String email, String firstName, String lastName, String phone) {
    ...
    @Test
    @DisplayName("searchClients: Should find clients by partial first name, case-insensitive")
    ...
    @Test
    @DisplayName("searchClients: Should find clients by partial last name, case-insensitive")
    ...
    @Test
    @DisplayName("searchClients: Should find clients by partial phone number")
    ...
    @Test
    @DisplayName("searchClients: Should return empty page when no match is found")
