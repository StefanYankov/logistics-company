...
import bg.nbu.cscb532.employee.EmployeeController;
import bg.nbu.cscb532.employee.EmployeeService;
...
public abstract class AbstractEmployeeControllerTestBase {

    protected static final String BASE_URL = "/api/employees";
